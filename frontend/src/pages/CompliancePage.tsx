  ...
  return (
    <Box p={6}>
      <VStack spacing={6} align="stretch">
        <Box>
          <Heading size="lg" mb={2}>Data Compliance & Management</Heading>
          <Text color="gray.600">
          ...
          <TabPanels>
              ...
              <VStack spacing={4} align="stretch">
                ...
                <Alert status="info">
                  ...
                  <Box>
                    ...
                    <AlertDescription>
                      Retention policies are automatically enforced daily at 2 AM.
                      Old data is archived before deletion.
                    </AlertDescription>
                  </Box>
                </Alert>
                ...
                <Table variant="simple">
                  ...
                  <Tbody>
                    {retentionPolicies.map((policy) => (
                      <Tr key={policy.id}>
                        <Td>
                          <Badge colorScheme="purple">{policy.resource_type}</Badge>
                        </Td>
                        <Td>{policy.retention_days} days</Td>
                        <Td>
                          <Badge colorScheme={policy.auto_archive ? 'green' : 'gray'}>
            ...
            <TabPanel>
              <VStack spacing={4} align="stretch">
                ...
                <Card>
                  ...
                  <CardBody>
                    <VStack spacing={3} align="stretch">
                      <Text>
                        You have the right to access and download all your personal data,
                        or request complete deletion of your account.
                      </Text>
                      <HStack>
                        <Button colorScheme="blue" onClick={requestDataExport}>
                          Export My Data
                        </Button>
                        <Button colorScheme="red" variant="outline" onClick={requestDataDeletion}>
                          Delete My Account
                        </Button>
                      </HStack>
                    </VStack>
                ...
                <Heading size="sm" mt={4}>Request History</Heading>
                <Table variant="simple">
                  <Thead>
                    <Tr>
                      <Th>Type</Th>
                  ...
                  <Tbody>
                    {gdprRequests.map((request) => (
                      <Tr key={request.id}>
                        <Td>
                          <Badge colorScheme={request.request_type === 'export' ? 'blue' : 'red'}>
                        ...
                        <Td>
                          <Badge
                            colorScheme={
                              ...
                              request.status === 'processing' ? 'yellow' : 'gray'
                            }
                          >
                            {request.status}
                          </Badge>
                        ...
                        <Td>
                          {request.export_url && (
                            <Button size="sm" as="a" href={request.export_url} download>
                              Download
                            </Button>
                          )}
                        </Td>
              ...
              <VStack spacing={4} align="stretch">
                ...
                <Alert status="warning">
                  ...
                  <Box>
                    ...
                    <AlertDescription>
                      SQL Studio automatically detects and masks PII in query results.
                      You can review and verify detected fields below.
                    </AlertDescription>
                  </Box>
                </Alert>
            ...
            <TabPanel>
              <VStack spacing={4} align="stretch">
                ...
                <Text color="gray.600">
                  View detailed audit trails of all data access and modifications.
                </Text>
                <Alert status="info">
                  <AlertIcon />
