...
export function WebSocketDebugPanel({
  ...
  const getEventTypeColor = useCallback((type: string) => {
    if (type.includes('query')) return 'text-blue-600 bg-blue-50';
    if (type.includes('table')) return 'text-green-600 bg-green-50';
    if (type.includes('connection')) return 'text-purple-600 bg-purple-50';
    if (type.includes('error')) return 'text-red-600 bg-red-50';
