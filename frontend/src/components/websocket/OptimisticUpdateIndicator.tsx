          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2 text-xs">
              <div className="text-center p-2 bg-blue-50 rounded">
                <div className="font-medium text-blue-700">{stats.pending}</div>
                <div className="text-blue-600">Pending</div>
              </div>
              <div className="text-center p-2 bg-green-50 rounded">
                <div className="font-medium text-green-700">{stats.confirmed}</div>
                <div className="text-green-600">Confirmed</div>
              </div>
              <div className="text-center p-2 bg-red-50 rounded">
                <div className="font-medium text-red-700">{stats.rejected}</div>
