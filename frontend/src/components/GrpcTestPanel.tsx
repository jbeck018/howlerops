...
import { useGrpcConnections, useCreateGrpcConnection, useTestGrpcConnection } from '../hooks/useGrpcConnections'
import { useGrpcStreamingQuery } from '../hooks/useGrpcStreamingQuery'
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card className="p-4">
        ...
        {testConnection.data && (
          <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded">
            <h4 className="font-medium text-green-800">Test Result:</h4>
      ...
      <Card className="p-4">
        ...
        {connectionsError && <p className="text-red-600">Error: {connectionsError.message}</p>}
      ...
      <Card className="p-4">
        ...
        {streamingQuery.progress && (
          <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded">
            <h4 className="font-medium text-blue-800">Query Progress:</h4>
        ...
        {streamingQuery.result && (
          <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded">
            <h4 className="font-medium text-green-800">Query Result:</h4>
        ...
        {streamingQuery.error && (
          <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded">
            ...
            <p className="text-sm text-red-700 mt-1">{streamingQuery.error.message}</p>
          </div>
        )}
      </Card>
