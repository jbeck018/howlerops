...
export function useWebSocket(options: UseWebSocketOptions = {}) {
  ...
  }, [connectionState.reconnectAttempts, opts.reconnectInterval, opts.maxReconnectAttempts]);
  ...
  }, [opts.url, opts.eventHandlers, scheduleReconnect, updateConnectionStatus]);
