...
func (s *TursoRemoteVectorStore) GetDocument(ctx context.Context, id string) (*Document, error) {
	return nil, fmt.Errorf("not supported")
}
func (s *TursoRemoteVectorStore) UpdateDocument(ctx context.Context, doc *Document) error {
...
func (s *TursoRemoteVectorStore) CreateCollection(ctx context.Context, name string, dimension int) error {
	return nil
}
func (s *TursoRemoteVectorStore) DeleteCollection(ctx context.Context, name string) error { return nil }
func (s *TursoRemoteVectorStore) ListCollections(ctx context.Context) ([]string, error) {
	return []string{}, nil
}
func (s *TursoRemoteVectorStore) GetStats(ctx context.Context) (*VectorStoreStats, error) {
...
func (s *TursoRemoteVectorStore) Backup(ctx context.Context, path string) error {
	return fmt.Errorf("not supported")
}
func (s *TursoRemoteVectorStore) Restore(ctx context.Context, path string) error {
	return fmt.Errorf("not supported")
}
